...
births <- get_eurostat('tgs00097', stringsAsFactors = FALSE) %>%
  select(geo, time, births = values)
...
save(euro_regio, file = 'euro_regio_0000.Rdata', compress = 'xz')
...
save(euro_regio_eu, file = 'euro_regio_eu_0000.Rdata', compress = 'xz')
